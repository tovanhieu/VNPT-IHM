...
const mainChat = require("./VNPT-IHM/intents/Main_Chat.json");
const supportChat = require("./VNPT-IHM/intents/support.json");
const wikipediaChat = require("./VNPT-IHM/intents/wikipedia.json");
const welcomeChat = require("./VNPT-IHM/intents/Default_Welcome.json");
const fallbackChat = require("./VNPT-IHM/intents/Default_Fallback.json");
const unitConverterChat = require("./VNPT-IHM/intents/unit_converter.json");
